...
export function fileCountBucket(count) {
    if (count < 50)
        return 'tiny';
    if (count < 500)
        return 'small';
 ...
 */
export function getRepoMetrics(dir, projectFp) {
    // Try cache first
...
export function computeRepoMetrics(dir) {
...
function writeCache(projectFp, metrics) {
    try {
...
//# sourceMappingURL=repo-metrics.js.map