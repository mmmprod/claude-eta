...
export function exportToFile(projName: string, pluginVersion: string): { path: string; count: number } {
...
export function showExport(projName: string, pluginVersion: string): void {
