...
export interface CommunityPrior {
  low: number; // p25_seconds
  median: number; // median_seconds
  high: number; // p75_seconds
  sample_count: number;
...
const ALL_CLASSIFICATIONS: TaskClassification[] = [
  'bugfix',
  'feature',
  'refactor',
  'config',
 ...
 */
export function baselinesToPriors(
  baselines: BaselineRecord[],
  locBucket: string | null,
  model: string | null,
): CommunityPriors {
  const priors: CommunityPriors = {};
